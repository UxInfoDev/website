  ...
  return (
    <div className="min-h-screen bg-t-bg">
      ...
      <div className="relative h-[60vh] md:h-[70vh] flex items-center overflow-hidden">
        <div 
          className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat transition-transform duration-[10s] scale-110 animate-subtle-zoom bg-image-dynamic"
          style={{ '--bg-image-dynamic': `url(${imageUrl || '/images/placeholder.jpg'})` }}
        />
        <div 
          className="absolute inset-0 z-10 bg-dynamic"
          style={{ '--bg-dynamic': randomGradient }}
        />
      ...
      <section className="py-16 md:py-24 relative -mt-20 z-30">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="bg-white p-8 md:p-16 rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-gray-100">
            <div className="prose prose-xl prose-slate max-w-none prose-headings:font-black prose-p:leading-[1.8] prose-theme-headings text-t-text">
              {(() => {
            ...
            {project.website_link && (
              <div className="mt-16 pt-12 border-t border-gray-100 flex justify-center">
                <a 
                  ...
                  className="group relative inline-flex items-center gap-4 px-12 py-5 text-white font-black rounded-2xl transition-all duration-500 shadow-2xl hover:-translate-y-2 uppercase tracking-[0.2em] text-[11px] bg-t-primary"
                >
